...
import com.example.gd10_c_10786.databinding.ActivityDetailMahasiswaBinding
import com.example.gd10_c_10786.databinding.ActivityFormAddMahasiswaBinding
...
class FormAddMahasiswaActivity : AppCompatActivity() {
    ...
    private fun dateToString(year: Int, month: Int, dayofMoth: Int):String{
        return year.toString()+"-"+(month+1)+"-"+dayofMoth.toString()
    }
